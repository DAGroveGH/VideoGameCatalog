    ...
    public class MockVideoGameData
    {
        public static List<VideoGameModel> Games => new()
        {
            new VideoGameModel
                {
                    ...
                    Developer = "Square",
                    Genre = "RPG",
                    CreatedAt = new DateTime(1995, 3, 11),
                    Ownership = "Owned",
                    PriceLoose = 49.99,
                    PriceCIB = 129.99,
                    PriceNew = null,
                    ...
                    tags = new List<string> { "rpg", "classic", "time-travel" },
                    Metacritic = 98
                },
            ...
            new VideoGameModel
            {
                ...
                tags = new List<string> { "story", "singleplayer", "dramatic" },
                Metacritic = 93
            },
            ...
            new VideoGameModel
            {
                ...
                Genre = "Action-Adventure",
                CreatedAt = new DateTime(2017, 3, 3),
                Ownership = "For Trade",
                PriceLoose = 34.99,
                PriceCIB = 49.99,
                PriceNew = 59.99,
                ...
                Notes = "Includes map.",
                tags = new List<string> { "open-world", "adventure", "zelda" },
                Metacritic = 97
            },
            ...
            new VideoGameModel
            {
                ...
                Genre = "Roguelike",
                CreatedAt = new DateTime(2020, 9, 17),
                Ownership = "Owned",
                PriceLoose = null,
                PriceCIB = null,
                PriceNew = 24.99,
                ...
                tags = new List<string> { "roguelike", "indie", "replayable" },
                Metacritic = 93
            },
            ...
            new VideoGameModel
            {
                ...
                Genre = "RPG",
                CreatedAt = new DateTime(1998, 10, 21),
                Ownership = "Owned",
                PriceLoose = 79.99,
                PriceCIB = 199.99,
                PriceNew = null,
                ...
                tags = new List<string> { "pokemon", "collectible", "handheld" },
                Metacritic = null
            }
        };
    }
